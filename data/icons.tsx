export const GithubIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
...
// #0A66C2
export const LinkedInIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const PinterestIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const DribbbleIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="1em"
        height="1em"
...
export const SunIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const MoonIcon = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="24"
        height="24"
...
export const CircularText = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width="496"
        height="496"
...
export const LinkArrow = ({ className, ...rest }: { className?: string;[key: string]: any }) => (
    <svg
        xmlns="http://www.w3.org/2000/svg"
        width={24}
        height={24}
